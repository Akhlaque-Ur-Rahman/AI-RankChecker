...
//
//  After you change this file: Deploy → Manage deployments → ✏️ Web App → Version: New version → Deploy.
//  Otherwise Sheet append may fail with "Unknown action: append_rankings" (old deployment still running).
// ================================================================
