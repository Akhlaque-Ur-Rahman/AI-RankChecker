    ...
    <div style={{ ...pageShell, display: "flex", justifyContent: "center", padding: "36px 20px 56px" }}>
      ...
      <div style={{ width: "100%", maxWidth: 620 }}>
        ...
        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 16, padding: "24px 26px", marginBottom: 20, boxShadow: cardShadow }}>
          ...
          <p style={{ fontSize: 12, color: C.muted, marginBottom: 18 }}>One-time setup. Script (repo root): <code style={{ background: C.faint, padding: "2px 8px", borderRadius: 4, color: C.cyan, fontSize: 11 }}>apps-script/gsc-rank-checker-v2.gs</code></p>
